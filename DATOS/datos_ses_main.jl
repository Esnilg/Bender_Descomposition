...
datos = readdlm("../DATOS/end_uses_demand_year.txt",'\t');
n,m = size(datos);
...
datos = readdlm("../DATOS/PERIODS.txt",'\t');
n,m = size(datos);
...
lifetime = Dict{SubString{String},Float64}(datos[i,1] => datos[i,6] for i =2:n);
